...
class Exp_Pretrain(Exp_Basic):
    ...
    def _build_model(self):
        # 读取邻接矩阵
        with open('/kaggle/input/met-la/METR-LA/adj_METR-LA.pkl', 'rb') as f:
    ...
    def train(self, setting):
        ...
        print('shape:', preds.shape, trues.shape, x_marks.shape, maes.shape, maes_time.shape, maes_target.shape)
