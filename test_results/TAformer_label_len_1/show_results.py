...
for i in range(x_trues.shape[0]):
    ...
    plt.text(-0.05, 20.5, 'MAE={0:.4f}'.format(maes[i]), ha='left', va='center', size=14, weight='bold')
    plt.text(-0.05, 15.5, 'MSE={0:.4f}'.format(mses[i]), ha='left', va='center', size=14, weight='bold')
    plt.text(-0.05, 10.5, 'MAPE={0:.4f}'.format(mapes[i]), ha='left', va='center', size=14, weight='bold')
    plt.text(-0.05, 5, 'MSPE={0:.4f}'.format(mspes[i]), ha='left', va='center', size=14, weight='bold')
    plt.text(-0.05, 0.5, 'RMSE={0:.4f}'.format(rmses[i]), ha='left', va='center', size=14, weight='bold')
    plt.legend()
    plt.show()
