...
class GraphWaveNet(nn.Module):
    ...
    def __init__(self, num_nodes, support_len, dropout=0.3, gcn_bool=False, addaptadj=True, aptinit=None, in_dim=2,out_dim=12,residual_channels=32,dilation_channels=32,skip_channels=256,end_channels=512,kernel_size=2,blocks=4,layers=2, **kwargs):
        """
    ...
    def forward(self, input, hidden_states, sampled_adj):
        ...
        # feed forward
        input = nn.functional.pad(input,(1,0,0,0))  # [B, C, N, L+1]
